<template>
  <div class="app-wrapper">
    <aside class="sidebar">
      ...
      <NuxtLink to="/staff/content/internal-system/vehicle" class="sidebar-link" :class="{ active: route.path === '/staff/content/internal-system/vehicle' }">
        📢 最新消息
      </NuxtLink>
      <NuxtLink to="/staff/content/internal-system/vehicle/booking" class="sidebar-link" :class="{ active: route.path === '/staff/content/internal-system/vehicle/booking' }">
        🚗 公務車線上申請
      </NuxtLink>
    </aside>
