...
const GOOGLE_CLIENT_ID = 'YOUR_GOOGLE_CLIENT_ID' // ← 換成你的
...
const initGoogle = () => {
  ...
  window.google.accounts.id.initialize({
    client_id: '441605672654-9j73r51g6j2mar17ptblhskfvard1em9.apps.googleusercontent.com',
...
const fetchMe = async () => {
  try {
    ...
    if (!data.error) customer.value = data
  } catch {
  }
}
