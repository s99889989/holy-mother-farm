<script setup>
  ...
  // 錨點根據10點實測最小二乘法校準（2026-05-23，僅保留實際測量點）
  const ANCHOR1 = { imgX: 0.550, imgY: 0.810, lat: 22.761240, lng: 121.094103 }
  const ANCHOR2 = { imgX: 0.700, imgY: 0.520, lat: 22.760886, lng: 121.095293 }
  ...
  // ── 設施資料（10點實測校準，僅保留實際量測設施 2026-05-23）────
  const landmarks = ref([
