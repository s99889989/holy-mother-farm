<template>
  <div class="sc-order-page">
    <nav class="sc-topnav">
      ...
      <NuxtLink to="/front/shopping-cart/users" class="sc-topnav-link sc-active">會員管理</NuxtLink>
      <NuxtLink to="/front/shopping-cart/managers" class="sc-topnav-link">管理員設定</NuxtLink>
    </nav>
