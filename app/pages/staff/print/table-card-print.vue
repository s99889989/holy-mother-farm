    ...
    <div class="layout">
      ...
      <div class="mobile-topbar bg-surface border-b border-light-c">
        <div class="mobile-topbar-inner">
          <div class="flex items-center gap-2">
            <div
              class="w-7 h-7 rounded-lg bg-slate-600 flex items-center justify-center text-white text-sm flex-shrink-0"
            >
              🏷️
            </div>
            <span
      ...
      >
        <div class="sidebar-header border-b border-light-c px-4 py-3">
          <div class="flex items-center gap-2">
            <div
              class="w-8 h-8 rounded-lg bg-slate-600 flex items-center justify-center text-white text-base flex-shrink-0"
            >
              🏷️
            </div>
            <div>
              <div
                class="font-bold text-base-c leading-none text-lg"
              >
                餐廳標籤桌牌
              </div>
              <div
                class="text-hint-c mt-0.5 text-sm"
              >
                勾選後列印，每頁 9 張 A4 橫向
              </div>
            </div>
