<script setup>
  ...
  // ── 客戶訂餐連結 ──────────────────────────────────────────────────
  const CUSTOMER_LUNCH_URL = 'https://holyfarm.netlify.app/front/order/lunch'
        ...
        <div class="w-full lg:w-72 xl:w-80 flex-shrink-0">
          ...
          <div class="hidden lg:block bg-surface rounded-2xl border border-light-c shadow-sm p-4 lg:sticky lg:top-20">
            ...
            <div class="flex items-center justify-between mt-3 pt-3 border-t border-light-c">
              ...
              <button @click="selectDate(todayStr)"
                      class="text-sm text-orange-600 dark:text-orange-400 hover:text-orange-700 font-medium">今天
              </button>
            </div>
          </div>
                    ...
                    <div class="flex-1 px-3 py-2.5 flex items-center justify-between gap-2">
                      <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 flex-wrap">
                          ...
                          <NuxtLink v-if="order.groupItineraryId"
      ...
      <div
        ...
        <div class="space-y-3">
          <div>
            ...
            <input v-model="lForm.date" type="date"
          ...
          <div>
            ...
            <p class="text-xs text-hint-c mt-1.5">合計：{{
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-2">
              <button v-for="s in LUNCH_STATUSES" :key="s" type="button"
                      ...
                      class="px-2.5 py-1 rounded-full text-xs font-medium transition-all">{{ s }}
              </button>
            </div>
          </div>
          <div>
