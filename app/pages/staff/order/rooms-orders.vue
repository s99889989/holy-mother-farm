<template>
  <div class="min-h-full bg-surface2 transition-colors">
    ...
    <!-- ===== 日曆檢視點擊：當日訂單詳情 Modal ===== -->
    <div v-if="dayTarget" class="fixed inset-0 bg-black/50 flex items-center justify-center z-30 px-4" @mousedown="onBackdropMousedown" @click="onBackdropClick($event, () => dayTarget = null)">
