    ...
    <div class="max-w-xl mx-auto">
      ...
      <template v-else>
        ...
        <div
          ...
          class="bg-surface rounded-2xl border border-light-c p-4 mb-4"
        >
          <h2 class="text-sm font-semibold text-base-c mb-1">
            使用中群組
          </h2>
          <p class="text-xs text-hint-c mb-3">
            切換群組會改變您看到的導覽選單與權限，不影響您可使用的群組範圍
          </p>
        ...
        <div class="bg-surface rounded-2xl border border-light-c overflow-hidden">
          <div class="px-5 py-3.5 border-b border-light-c dark:border-base">
            <h2 class="text-sm font-semibold text-base-c">
              聯絡資訊
            </h2>
          </div>
          ...
          <div class="p-5 space-y-4">
            ...
            <p
              v-if="error"
              class="text-xs text-red-500 bg-red-50 dark:bg-red-900/20 rounded-xl px-4 py-2.5"
            >
              {{ error }}
            </p>
